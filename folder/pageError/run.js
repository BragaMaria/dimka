...
const FourOhFour = () => {
  ...
  return /*#__PURE__*/(
    ...
    React.createElement(Message, { className: "return-link", href: "../pageInternet/index.html", rel: "noreferrer noopener" }, "вернуться на главную страничку"), /*#__PURE__*/


    React.createElement(Logo, { className: " bear-logo " }), /*#__PURE__*/
    React.createElement(Code, { className: "four-oh-four__code" }, "Sorry,"), /*#__PURE__*/
    React.createElement(CodeMessage, { className: "four-oh-four__code-message" }, "Нам было лень сделать эту страничку"))));
